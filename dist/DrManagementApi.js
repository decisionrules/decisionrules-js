...
exports.DrManagementApi = void 0;
var DecisionRulesBase_1 = require("./DecisionRulesBase");
var axios_1 = __importDefault(require("axios"));
var DrManagementApi = /** @class */ (function (_super) {
    __extends(DrManagementApi, _super);
    function DrManagementApi(config) {
        var _this = _super.call(this, config) || this;
        _this.url = _super.prototype.crudUrlFactory.call(_this);
        _this.headers = _super.prototype.publicApiHeaderFactory.call(_this);
        return _this;
    }
    DrManagementApi.prototype.getApiCall = function (getUrl) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.get(getUrl, { headers: this.headers }).then(function (response) {
    ...
    * */
    ...
    return DrManagementApi;
}(DecisionRulesBase_1.DecisionRulesBase));
exports.DrManagementApi = DrManagementApi;
